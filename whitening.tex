...
The remaining non-while variables give us an under-approximation of frozen literals in the model $\lambda$ of $\Phi$, namely,
...
Therefore, we can infer that if the variable $x$ is white, then the literals $\neg x$ and $x$ cannot be frozen literals.

...
to the state-of-the-art tool \textit{cb100}. Moreover, \tool reduces 40\% running time for hard random formulae and cut off 12\% running time for industrial formulae comparing to \textit{cb100}.

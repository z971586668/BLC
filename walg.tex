...
\begin{enumerate}
    ...
    \item ${\sf HS}_3(\Phi$): select maximal $\f(l)\div\dens(l), l\in\Lit(\Phi)$ for each iteration, i.e., $\forall l, {\sf max}\{\f(l)\div\dens(l), l\in\Lit(\Phi)\}$
    \item ${\sf HS}_4(\Phi$): select maximal $\f(l)\div\dens(l), l\in\Lit(\Phi)$ for each iteration, i.e., $\forall l, {\sf min}\{\f(l)\div\dens(l), l\in\Lit(\Phi)\}$
 \end{enumerate}

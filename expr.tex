...
On the random formulae side, we used 100 unsatisfiable random formulae to extracted 6606 satisfiable formulae using the following approach.
...
We use LBX \cite{MPA2015} to generate 6606 maximal satisfiable subsets from the 100 unsatisfiable random formulae.
